...
class AuthTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # This is the user test json data with a predefiend email and password
        self.user_data = {
    ...
    def test_registration(self):
        """Test user registrations works correctly"""
    ...
    def test_already_registered_user(self):
        ...
        # get the results returend in json format
